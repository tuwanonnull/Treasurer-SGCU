...
(function initFeatureLoader() {
  ...
  const config = {
    ...
    pageScripts: {
      ...
      "meeting-room-booking": "js/features/booking/app.meeting-room-booking.js?v=20260825-calendar-views-5",
      "meeting-room-staff": [
        "js/features/booking/app.meeting-room-booking.js?v=20260825-calendar-views-5",
        "js/features/booking/app.meeting-room-staff.js?v=20260825-calendar-views-3"
      ],
