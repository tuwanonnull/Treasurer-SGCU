const CACHE_VERSION = "20260827-meeting-scroll-offset-1";
const CACHE_PREFIX = "treasurer-sgcu-shell";
const CACHE_NAME = `${CACHE_PREFIX}-${CACHE_VERSION}`;
const APP_SHELL_URLS = [
  "./",
  "./index.html",
  "./css/style.css?v=20260827-meeting-mobile-menu-1",
  ...
  "./js/core/app.feature-loader.js?v=20260827-mobile-dropdown-only-1",
