const CACHE_VERSION = "20260906-calendar-native-picker-2";
const CACHE_PREFIX = "treasurer-sgcu-shell";
const CACHE_NAME = `${CACHE_PREFIX}-${CACHE_VERSION}`;
const APP_SHELL_URLS = [
  "./",
  "./index.html",
  "./css/style.css?v=20260906-calendar-native-picker-2",
  ...
  "./js/core/app.feature-loader.js?v=20260906-calendar-native-picker-2",
